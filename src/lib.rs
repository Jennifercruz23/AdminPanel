...
#[derive(Debug)]
pub struct AdminPanelProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AdminPanelProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AdminPanel processing");
    
    let mut processor = AdminPanelProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AdminPanelProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AdminPanelProcessor::new(false);
